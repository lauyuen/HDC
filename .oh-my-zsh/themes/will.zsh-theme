...
then
  RPROMPT='%B%F{160}l%f%F{196}a%f%F{202}u%f%F{208}y%f%F{214}u%f%F{220}e%f%F{226}n%f%{$fg_bold[white]%}@%F{154}%m%f%{$reset_color%}'
else
  RPROMPT='%B%F{124}%n%f%{$fg_bold[white]%}@%F{154}%m%f%{$reset_color%}'
fi
